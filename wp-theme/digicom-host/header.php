	...
	<div class="wrap">
		...
		<nav class="nav">
			...
			if ( has_nav_menu( 'primary' ) ) {
				...
				echo '<ul><li><a href="' . esc_url( home_url( '/' ) ) . '">Trang chủ</a></li><li><a href="' . esc_url( home_url( '/#services' ) ) . '">Dịch vụ</a></li><li><a href="' . esc_url( home_url( '/bang-gia/' ) ) . '">Bảng giá</a></li><li><a href="' . esc_url( home_url( '/cau-hoi-thuong-gap/' ) ) . '">Câu hỏi thường gặp</a></li><li><a href="' . esc_url( home_url( '/lien-he/' ) ) . '">Liên hệ</a></li></ul>';
			}
			?>
		</nav>
