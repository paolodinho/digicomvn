	...
	<div class="wrap">
		...
		<nav class="nav">
			...
			if ( has_nav_menu( 'primary' ) ) {
				...
				echo '<ul><li><a href="' . esc_url( home_url( '/dich-vu/mua-textlink/' ) ) . '">Mua Textlink</a></li><li><a href="' . esc_url( home_url( '/dich-vu/dich-vu-backlink/' ) ) . '">Dịch vụ Backlink</a></li><li><a href="' . esc_url( home_url( '/dich-vu/guest-post/' ) ) . '">Guest Post</a></li><li><a href="' . esc_url( home_url( '/dich-vu/booking-bao-pr/' ) ) . '">Booking báo &amp; PR</a></li><li><a href="' . esc_url( home_url( '/lien-he/' ) ) . '">Liên hệ</a></li></ul>';
			}
			?>
		</nav>
		...
		<div class="header-cta">
			...
			<a class="btn btn-primary btn-sm" href="<?php echo esc_url( home_url( '/lien-he/' ) ); ?>#lien-he">Đặt bài ngay</a>
