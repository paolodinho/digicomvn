<?php
/*
 * Template Name: DGC Landing - Booking bao PR
...
<title>Booking Báo &amp; PR — Báo Giá Đăng Bài PR Theo Từng Đầu Báo | Digicom</title>
<meta name="description" content="Dịch vụ booking báo &amp; PR Digicom: đặt đăng bài PR trên báo điện tử lớn (VnExpress, Kenh14, CafeF, 24h, Dân Trí...). Báo giá minh bạch theo từng đầu báo và vị trí đăng.">
<style>
:root{
...
/* ARTICLE MOCK (hero guestpost) */
.artdoc{background:#fff;border:1px solid var(--line);border-radius:16px;box-shadow:0 34px 64px -32px rgba(14,36,56,.34);overflow:hidden;transform:rotate(-1deg)}
.artdoc-bar{display:flex;align-items:center;gap:8px;padding:12px 16px;background:var(--paper-2);border-bottom:1px solid var(--line);font-size:12.5px;color:var(--ink-2)}
.artdoc-bar .fav{width:18px;height:18px;border-radius:5px;background:var(--blue)}
.artdoc-body{padding:24px}
.artdoc h4{font-size:20px;color:var(--blue-ink);line-height:1.25;margin-bottom:10px}
.artdoc .by{display:flex;align-items:center;gap:8px;margin-bottom:16px}
.artdoc .by .a{width:26px;height:26px;border-radius:50%;background:var(--tint-blue)}
.artdoc .by span{font-size:12px;color:var(--ink-2)}
.artdoc .ln{height:9px;border-radius:5px;background:var(--paper-2);margin-bottom:10px}
.artdoc .hl{background:linear-gradient(transparent 60%,rgba(0,174,156,.18) 60%);padding:2px 0;font-size:14.5px;color:#33404F;line-height:1.7}
.artdoc .hl a{color:var(--cta);font-weight:700;text-decoration:underline}
.artdoc-foot{display:flex;align-items:center;gap:8px;margin-top:14px}
.artdoc .tag{font-size:11px;font-weight:700;color:var(--cta);background:var(--tint-teal);border-radius:20px;padding:3px 10px}
.artdoc .tag.b{color:var(--blue);background:var(--tint-blue)}

/* TOPICS grid */
.topics{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}
.topic{border:1px solid var(--line);border-radius:12px;padding:16px 18px;background:#fff;display:flex;align-items:center;gap:10px;font-weight:600;color:var(--blue-ink);font-size:14.5px;transition:.15s}
.topic:hover{border-color:#C7D6EE;box-shadow:0 12px 24px -18px rgba(0,72,216,.4)}
.topic .d{width:10px;height:10px;border-radius:50%;background:var(--blue);flex:0 0 auto}
.topic:nth-child(3n) .d{background:var(--cta)}
@media(max-width:820px){.topics{grid-template-columns:1fr 1fr}}


/* PRICING cards (guestpost) */
.price-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:18px;align-items:stretch}
.pcard{background:#fff;border:1px solid var(--line);border-radius:14px;padding:28px 26px;display:flex;flex-direction:column}
.pcard.hot{border:0;background:linear-gradient(165deg,var(--blue-ink),var(--blue-d));color:#fff;position:relative;box-shadow:0 26px 50px -26px rgba(11,35,80,.6);transform:scale(1.03)}
.pcard.hot:before{content:"Được chọn nhiều";position:absolute;top:-11px;left:26px;background:var(--cta);color:#fff;font-size:11px;font-weight:700;padding:3px 12px;border-radius:20px}
.pcard.hot h3,.pcard.hot .pp b{color:#fff}.pcard.hot .pp{color:#B9C7DE}.pcard.hot li{color:#C6D3E7}.pcard.hot li:before{color:#7FE0D3}
.pcard h3{font-size:19px}.pcard .pp{font-size:15px;color:var(--ink-2);margin:14px 0 2px}.pcard .pp b{font-size:28px;color:var(--blue)}
.pcard ul{list-style:none;margin:18px 0 24px;display:grid;gap:10px}
.pcard li{font-size:14px;color:var(--ink-2);padding-left:24px;position:relative}
.pcard li:before{content:"✓";position:absolute;left:0;color:var(--cta);font-weight:800}
.pcard .btn{margin-top:auto;justify-content:center}
@media(max-width:820px){.price-grid{grid-template-columns:1fr}.pcard.hot{transform:none}}


/* PRESS NETWORK */
.press-net{display:grid;grid-template-columns:repeat(8,1fr);gap:14px}
.press-net .p{height:70px;background:#fff;border:1px solid var(--line);border-radius:12px;display:flex;align-items:center;justify-content:center;padding:12px}
.press-net .p img{max-height:34px;max-width:80%;object-fit:contain}
@media(max-width:820px){.press-net{grid-template-columns:repeat(3,1fr)}}
/* CHILD (trang con theo bao) */
.kids{display:grid;grid-template-columns:repeat(5,1fr);gap:14px}
.kid{border:1px solid var(--line);border-radius:14px;padding:18px;background:#fff;text-align:center;transition:.15s}
.kid:hover{border-color:#C7D6EE;box-shadow:0 14px 30px -20px rgba(0,72,216,.4);transform:translateY(-2px)}
.kid img{height:26px;margin:4px auto 12px;object-fit:contain}
.kid .g{font-size:12px;color:var(--ink-2)}
.kid .g b{color:var(--blue);font-weight:800;display:block;font-size:15px;margin-top:2px}
.kid a{font-size:12.5px;color:var(--cta);font-weight:700;display:block;margin-top:10px}
@media(max-width:820px){.kids{grid-template-columns:1fr 1fr}}
.pt .logocell{display:flex;align-items:center;gap:10px}
.pt .logocell img{height:20px;width:auto;object-fit:contain}
...
<div class="crumb"><div class="wrap"><a>Trang chủ</a><span>›</span><a>Dịch vụ</a><span>›</span>Booking báo &amp; PR</div></div>

<!-- 1. HERO -->
<section class="phero"><div class="wrap phero-grid">
  <div>
    <span class="kicker">Booking báo &amp; PR</span>
    <h1>Đăng bài <em>PR trên báo điện tử</em> — báo giá theo từng đầu báo</h1>
    <p class="sub">Đặt bài PR trên VnExpress, Kenh14, CafeF, 24h, Dân Trí... Digicom booking trực tiếp, giá minh bạch theo từng vị trí đăng, chủ động lịch lên bài.</p>
    <div class="phero-actions">
      <a href="<?php echo esc_url( home_url( "/lien-he/" ) ); ?>" class="btn btn-primary">Nhận báo giá đăng báo</a>
      <a href="<?php echo esc_url( home_url( "/lien-he/" ) ); ?>" class="btn btn-outline">Xem bảng giá theo báo</a>
    </div>
    <div class="hero-checks">
      <div class="hc">Booking <b>trực tiếp</b></div>
      <div class="hc">Gồm <b>viết bài</b></div>
      <div class="hc">Bài <b>giữ lâu dài</b></div>
    </div>
  </div>
  <div class="artdoc">
    <div class="artdoc-bar"><span class="fav"></span>vnexpress.net · Doanh nghiệp</div>
    <div class="artdoc-body">
      <h4>Digicom Combat mở rộng hệ sinh thái truyền thông số năm 2026</h4>
      <div class="by"><span class="a"></span><span>Bài PR · Doanh nghiệp · 12/06/2026</span></div>
      <div class="ln" style="width:100%"></div><div class="ln" style="width:95%"></div>
      <p class="hl">Đại diện công ty cho biết, <a>giải pháp booking báo &amp; PR</a> giúp doanh nghiệp tiếp cận hàng triệu độc giả trên các báo điện tử lớn.</p>
      <div class="ln" style="width:90%;margin-top:12px"></div><div class="ln" style="width:66%"></div>
      <div class="artdoc-foot"><span class="tag">✓ dofollow</span><span class="tag b">trang chủ</span><span class="tag b">giữ theo domain</span></div>
    </div>
  </div>
</div></section>
...
<section class="sec"><div class="wrap">
  <div style="max-width:640px;margin-bottom:24px">
    <span class="kicker">Mạng lưới báo chí</span>
    <h2 style="font-size:32px;margin:12px 0 10px">Hệ thống đầu báo Digicom booking</h2>
    <p style="color:var(--ink-2);font-size:16.5px">Đặt bài trực tiếp trên các báo điện tử uy tín, đa lĩnh vực — từ tin tức, kinh tế đến giải trí, công nghệ.</p>
  </div>
  <div class="press-net">
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/vnexpress.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/dantri.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/tuoitre.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/thanhnien.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/vietnamnet.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/kenh14.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/cafef.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/tw24h.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/vtv.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/vov.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/laodong.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/tienphong.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/nhandan.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/znews.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/soha.png"></div>
    <div class="p"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/nguoiduatin.png"></div>
  </div>
</div></section>

<!-- 2d. BANG GIA THEO DAU BAO (that) -->
<section class="sec" style="background:var(--paper-2)"><div class="wrap">
  <div style="max-width:680px;margin-bottom:26px">
    ...
    <h2 style="font-size:32px;margin:12px 0 10px">Báo giá đăng bài PR theo từng đầu báo</h2>
    <p style="color:var(--ink-2);font-size:16.5px">Giá tham khảo (đã gồm viết bài), thay đổi theo vị trí đăng và thời gian tồn tại. Trang chủ luôn cao nhất.</p>
  </div>
  <div class="pt-wrap">
    <div class="pt-bar">
      <input type="text" placeholder="Tìm theo tên báo...">
      <span class="pchip on">Tất cả</span>
      <span class="pchip">VnExpress</span>
      <span class="pchip">Kenh14</span>
      <span class="pchip">CafeF</span>
      <span class="pchip">24h</span>
    </div>
    <div class="pt-scroll"><table class="pt">
      <thead><tr><th>Đầu báo</th><th>Vị trí đăng</th><th>Giá từ</th><th></th></tr></thead>
      <tbody>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/kenh14.png"><span class="nm">Kenh14.vn</span></span><span class="tag edu">Giá tốt</span></td><td class="sub">Tiểu mục (Học đường, Công nghệ, Sao, Phim...)</td><td><span class="now">3.700.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/kenh14.png"><span class="nm">Kenh14.vn</span></span></td><td class="sub">Xem – Ăn – Chơi</td><td><span class="now">6.100.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/kenh14.png"><span class="nm">Kenh14.vn</span></span></td><td class="sub">Trang chủ</td><td><span class="now">10.200.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/tw24h.png"><span class="nm">24h.com.vn</span></span></td><td class="sub">Bài PR loại 2 (mục còn lại)</td><td><span class="now">3.800.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/tw24h.png"><span class="nm">24h.com.vn</span></span></td><td class="sub">Loại 2 (Thị trường tiêu dùng, Kinh doanh)</td><td><span class="now">4.500.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/tw24h.png"><span class="nm">24h.com.vn</span></span></td><td class="sub">Bài PR loại 1 (trang chủ)</td><td><span class="now">7.300.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/cafef.png"><span class="nm">CafeF.vn</span></span></td><td class="sub">Box thông cáo báo chí (trang chủ 1 ngày)</td><td><span class="now">5.400.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/cafef.png"><span class="nm">CafeF.vn</span></span></td><td class="sub">Tin doanh nghiệp (trang chủ 1 ngày)</td><td><span class="now">6.600.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/cafef.png"><span class="nm">CafeF.vn</span></span></td><td class="sub">Chuyên mục (BĐS, Tài chính, Chứng khoán...)</td><td><span class="now">10.400.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr class="hot"><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/vnexpress.png"><span class="nm">VnExpress.net</span></span><span class="tag edu">Phổ biến</span></td><td class="sub">Doanh nghiệp viết (tồn tại 6 tháng)</td><td><span class="now">7.800.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/vnexpress.png"><span class="nm">VnExpress.net</span></span></td><td class="sub">Giáo dục, Số hoá</td><td><span class="now">9.200.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/vnexpress.png"><span class="nm">VnExpress.net</span></span></td><td class="sub">Doanh nghiệp viết (tồn tại 24 tháng)</td><td><span class="now">11.800.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
        <tr><td><span class="logocell"><img src="<?php echo esc_url( content_url( "/uploads/" ) ); ?>press-logos/vnexpress.png"><span class="nm">VnExpress.net</span></span></td><td class="sub">Doanh nghiệp viết (giữ theo domain)</td><td><span class="now">15.300.000đ</span></td><td><button class="pick">Đặt</button></td></tr>
      </tbody>
    </table></div>
  </div>
  <p class="pt-note">Danh sách rút gọn. Xem đầy đủ báo giá &amp; quy trình theo từng đầu báo bên dưới, hoặc tại trang <a>Bảng giá</a>.</p>
</div></section>
...
<section class="sec"><div class="wrap faq-wrap">
  ...
  <div class="faq-list">
    <details open><summary>Đăng bài PR trên báo nào rẻ nhất?</summary><div class="a">Trong nhóm báo lớn, Kenh14 (tiểu mục) từ 3.7 triệu và 24h (loại 2) từ 3.8 triệu là mức khởi điểm thấp. Giá còn tuỳ vị trí và thời gian tồn tại — gọi để được tư vấn theo ngân sách.</div></details>
    <details><summary>Vì sao đăng PR trang chủ đắt hơn nhiều so với chuyên mục?</summary><div class="a">Trang chủ có lượng truy cập lớn nhất và vị trí hiển thị tốt nhất nên giá cao hơn. Ví dụ Kenh14 tiểu mục 3.7tr nhưng trang chủ tới 10.2tr. Tuỳ mục tiêu, chuyên mục đúng ngành đôi khi hiệu quả hơn.</div></details>
    <details><summary>Giá đăng bài PR đã gồm viết nội dung chưa?</summary><div class="a">Đã gồm. Digicom viết bài chuẩn văn phong báo chí, gửi bạn duyệt trước khi đăng. Bạn chỉ cần cung cấp thông tin, định hướng.</div></details>
    <details><summary>Bài PR tồn tại trên báo bao lâu?</summary><div class="a">Tuỳ gói và báo: có gói tồn tại 6 tháng, 24 tháng, hoặc giữ theo domain (lâu dài). Ví dụ VnExpress có gói 6 tháng (7.8tr), 24 tháng (11.8tr) và theo domain (15.3tr).</div></details>
    <details><summary>Đăng cùng lúc nhiều đầu báo có tối ưu chi phí không?</summary><div class="a">Có. Book combo nhiều báo thường được mức tốt hơn và tăng độ phủ. Digicom tư vấn lựa chọn đầu báo phù hợp mục tiêu &amp; ngân sách của bạn.</div></details>
  </div></section>

<!-- 9. CTA -->
<section class="sec" style="padding-top:0"><div class="wrap"><div class="cta">
  <div><h2>Cần đặt bài PR trên báo?</h2><p>Cho biết đầu báo &amp; mục tiêu, Digicom gửi báo giá và lịch lên bài trong 24 giờ.</p></div>
...
<section class="sec"><div class="wrap">
  <div style="max-width:620px;margin-bottom:26px"><span class="kicker">Tìm hiểu thêm</span><h2 style="font-size:30px;margin-top:12px">Kiến thức booking báo &amp; PR liên quan</h2></div>
  <div class="rel-grid">
    <div class="rel"><span class="k">Kiến thức</span><a>Booking báo là gì? Đăng bài PR trên báo hoạt động thế nào →</a></div>
    <div class="rel"><span class="k">Cách viết</span><a>Cách viết bài PR chuẩn báo chí, dễ được duyệt →</a></div>
    <div class="rel"><span class="k">So sánh</span><a>Booking báo PR và quảng cáo báo: khác nhau thế nào →</a></div>
    <div class="rel"><span class="k">Chọn báo</span><a>Cách chọn đầu báo phù hợp ngân sách &amp; mục tiêu →</a></div>
    <div class="rel"><span class="k">Case study</span><a>Chiến dịch PR ấn tượng: cách triển khai bài bản →</a></div>
    <div class="rel"><span class="k">Dịch vụ khác</span><a>Mua Textlink · Dịch vụ Backlink · Guest Post →</a></div>
  </div>
</div></section>
