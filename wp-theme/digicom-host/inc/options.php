...
function dgc_defaults() {
	return array(
		...
		// FAQ BO SUNG - CHI hien o trang rieng /cau-hoi-thuong-gap/ (khong lap lai o trang chu).
		// Cung dinh dang "faqs": cau hoi | tra loi. Nguon: research SERP + Google Suggested/PAA
		// cho cum tu khoa mua backlink/textlink/guest post/booking bao (2026-07-29).
		'faq_page_extra' => "Mua textlink, backlink, guest post có vi phạm nguyên tắc của Google không? | Google không khuyến khích mua bán liên kết chỉ nhằm thao túng thứ hạng, nhưng rủi ro chủ yếu đến từ nguồn kém chất lượng: site không liên quan, anchor text lặp lại máy móc, tốc độ đi link bất thường. DigicomVN chọn báo và site theo DR, traffic thật, giữ tỷ lệ anchor tự nhiên và triển khai theo tốc độ hợp lý để hạn chế rủi ro thuật toán.\nBao lâu thì thấy hiệu quả sau khi đi backlink hoặc textlink? | Chỉ số kỹ thuật như Domain Rating, số backlink trỏ về thường ghi nhận thay đổi sau 2 đến 4 tuần khi Google crawl lại các trang chứa link mới. Thứ hạng từ khóa còn phụ thuộc chất lượng on-page và độ cạnh tranh của từ khóa, nên thời gian thấy rõ trên kết quả tìm kiếm thường tính bằng tháng.\nCó được chọn hoặc xem trước báo, site trước khi đặt không? | Có. Bảng giá công khai từng đầu báo và site kèm chỉ số ngay tại trang Bảng giá, khách có thể tự chọn hoặc yêu cầu tư vấn chọn theo ngành hàng và ngân sách trước khi chốt.\nNếu bài PR hoặc guest post bị tòa soạn biên tập, cắt bớt nội dung thì sao? | Mỗi đầu báo có tôn chỉ và quy chuẩn biên tập riêng, đội biên tập có thể chỉnh câu chữ cho phù hợp văn phong nhưng không thay đổi nội dung cốt lõi bài đã duyệt. DigicomVN gửi bản demo để khách xem trước khi đăng chính thức.\nBài đã đăng có bị gỡ xuống không, có cam kết thời gian tồn tại không? | Thời gian lưu bài phụ thuộc chính sách lưu trữ của từng đầu báo hoặc site, không phải quyết định của DigicomVN. Với các gói có cam kết thời gian tối thiểu, thông tin này được ghi rõ trong báo giá và hợp đồng trước khi triển khai.\nCó xuất hóa đơn VAT không? | Có. DigicomVN xuất hóa đơn VAT đầy đủ theo yêu cầu và theo quy định hiện hành.\nThanh toán bằng hình thức nào, có cần đặt cọc không? | Thanh toán chuyển khoản theo báo giá đã thống nhất; đơn đặt nhiều đầu báo hoặc site có thể chia đợt theo tiến độ triển khai. Điều kiện cụ thể được nêu rõ trong báo giá trước khi khách xác nhận.\nThông tin khách hàng và nội dung bài viết có được bảo mật không? | Có. Thông tin doanh nghiệp, nội dung bài viết và tài khoản liên quan chỉ dùng để triển khai dịch vụ, không chia sẻ cho bên thứ ba ngoài phạm vi cần thiết là tòa soạn hoặc site đăng bài.\nKhác biệt giữa Guest Post và Booking báo & PR là gì? | Guest Post đăng trên website hoặc blog theo chủ đề liên quan, phù hợp xây dựng backlink kỹ thuật; Booking báo & PR đăng trên báo điện tử chính thống, thiên về xây dựng uy tín thương hiệu và độ phủ truyền thông. Có thể kết hợp cả hai tùy mục tiêu SEO hay branding.\nDigicomVN có nhận đặt backlink trên tên miền .gov.vn hoặc .edu.vn không? | Không. DigicomVN không cung cấp và không nhận triển khai bất kỳ hình thức đặt liên kết trả phí nào trên tên miền .gov.vn hoặc .edu.vn, vì đây là hành vi vi phạm pháp luật do cơ quan nhà nước và trường học không có cơ chế bán quảng cáo hoặc bán liên kết hợp pháp.\nCó hợp đồng hay chỉ báo giá bằng lời không? | Có hợp đồng hoặc xác nhận báo giá bằng văn bản trước khi triển khai, nêu rõ phạm vi công việc, thời gian và chi phí.",
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				dgc_field( 'faqs', 'Cau hoi thuong gap (hien o TRANG CHU)', 'Moi dong: cau hoi | tra loi. Danh sach nay CUNG hien o dau trang /cau-hoi-thuong-gap/, muc "Cau hoi chung".', 'textarea' );
				dgc_field( 'faq_page_extra', 'FAQ bo sung - CHI hien o trang /cau-hoi-thuong-gap/', 'Moi dong: cau hoi | tra loi. Dung cho cau hoi chi tiet hon, khong can lap lai o trang chu (VD: an toan Google, thoi gian hieu qua, thanh toan, VAT, bao mat...).', 'textarea' );
				?>
			</table>
