...
function dgc_ai_system_prompt() {
	...
	$sp .= "1. Mua Textlink (/dich-vu/mua-textlink/): chen link vao bai viet co san tren site chat luong, chon theo DR/traffic.\n";
	$sp .= "2. Dich vu Backlink (/dich-vu/dich-vu-backlink/): he thong backlink chat luong, da nguon, an toan; co ngach Bat dong san.\n";
	$sp .= "3. Guest Post (/dich-vu/guest-post/): viet bai + dang tren site dung chu de, link dofollow.\n";
	$sp .= "4. Booking bao & PR (/dich-vu/booking-bao-pr/): dat bai PR tren bao dien tu uy tin (VnExpress, Dan Tri, CafeF, Kenh14, 24h...).\n";
	$sp .= "5. Backlink Social Entity (/dich-vu/backlink-social-entity/): ho so social chuan NAP, noi dung doc ban, lam thu cong; ban theo goi.\n";
	$sp .= "6. Backlink quoc te (/dich-vu/backlink-quoc-te/): guest post/niche edit va PR bao quoc te theo tang DR/DA.\n";
	$sp .= "7. Booking truyen hinh (/dich-vu/booking-truyen-hinh/): TVC, phong su, talkshow tren VTV, HTV.\n\n";
