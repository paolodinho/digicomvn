...
(`.Codex/rules/pivot-2026-07.md` mục Sitemap) - mỗi money page phải có
...
`.Codex/commands/internal-link-map.md` gọi `tools/internal-link-map.py` +
...
3. Đối chiếu từ khoá thật: research SERP theo `.Codex/rules/audit-intent-truoc.md`
   + `.Codex/rules/do-dont.md` (Google Suggest, PAA, top 10) - không đoán gap.
...
Nguyên tắc sửa (theo `.Codex/rules/uu-dai-cta.md` + `pivot-2026-07.md`):
...
`~/Codex-Workspace/_backups/routines/<ngày>/internal-link-fix/post{id}-BEFORE.json`,
...
## Liên quan
- `.Codex/rules/pivot-2026-07.md` - sitemap 8 pillar dịch vụ hiện hành, tham chiếu BƯỚC 2.
- `.Codex/rules/uu-dai-cta.md` - quy ước CTA `/dat-bai/`, lý do bỏ `/bang-gia/`.
- `.Codex/rules/audit-intent-truoc.md`, `.Codex/rules/do-dont.md` - research SERP trước khi viết bài lấp gap.
- `.Codex/rules/external-link-eeat.md` - ưu tiên link nội bộ trước link ngoài khi site đã có bài riêng.
- `.Codex/rules/khong-link-doi-thu.md` - không link/nhắc đối thủ trong bài lấp gap.
- `.Codex/rules/routine-backup.md`, `.Codex/rules/backup-before-edit.md` (global) - backup bắt buộc trước khi PUT.
- `.Codex/skills/content-pipeline/SKILL.md` - quy trình viết bài đầy đủ khi lấp content gap.
