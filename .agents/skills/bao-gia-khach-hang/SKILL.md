...
> Quy tắc gốc về giá/chiết khấu/công thức: đọc `.Codex/rules/bao-gia-khach-hang.md`
...
1. Tính giá theo đúng công thức đang chốt (đọc `.Codex/rules/bao-gia-khach-hang.md`
...
- `.Codex/rules/bao-gia-khach-hang.md` - toàn bộ nguyên tắc tính giá/chiết khấu/trình bày.
- `~/.Codex/rules/bao-gia-khong-lo-gia-von.md` (global) - nguyên tắc gốc không lộ giá vốn,
  áp dụng mọi dự án.
