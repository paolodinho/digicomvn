...
| 2026-07-19 | Content pipeline - cụm Backlink, đợt tiếp tục | Tiếp tục session Claude Code on the web (PR #4, branch claude/digicomvn-backlink-plan-0m9ouh) - việc còn thiếu là đăng qua SSH. Xác nhận title pillar page 268 "Dịch vụ Backlink" ĐÚNG (không sửa). Cập nhật title/H1/link nội bộ post 1276 (backlink-bat-dong-san) theo cụm "backlink chất lượng bất động sản". Đăng 2 bài mới category Backlink & Off-page: co-nen-mua-backlink-khong (post 4226, widget dgc_offpage_quiz) và mua-backlink-bao-la-gi (post 4228, widget dgc_budget_calc) - đều có thumbnail, đã research SERP top 10 trước khi viết (chi tiết content/cluster-backlink.md + content/run-2026-07-19-backlink.md). Internal link 2 chiều: post 1276 -> 2 bài mới, post 1260 (booking-bao-la-gi) -> mua-backlink-bao-la-gi. Backup + manifest tại ~/Claude-Workspace/_backups/routines/2026-07-19/content-pipeline/. Bài P1 "Cách đặt backlink hiệu quả" DỪNG - phát hiện trùng lặp intent với post 232 (back-link-hieu-qua) đã có sẵn, chờ Hiếu chọn hướng xử lý (chi tiết content/cluster-backlink.md). GSC: submit được 1/3 URL (backlink-bat-dong-san), 2 URL còn lại dở dang do lỗi hạ tầng tool trình duyệt.
| 2026-07-20 | Content pipeline - hoàn tất GSC + refresh bài 232 thay vì viết P1 mới | Submit GSC 2 URL còn lại (co-nen-mua-backlink-khong, mua-backlink-bao-la-gi) - đủ 3/3. Theo phương án đã đề xuất (refresh thay vì viết mới để tránh cannibalization với post 232), bổ sung mục "3.8. Lộ trình đi backlink theo giai đoạn tuổi domain" vào post 232 (back-link-hieu-qua) - đúng góc info gain 0-3-6-12 tháng dự kiến cho bài P1, có 2 link mới tới /guest-post/ và /dich-vu-backlink/. Backup + verify curl 200, submit GSC lại cho URL này.
