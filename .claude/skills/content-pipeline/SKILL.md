...
## BƯỚC 2 - RESEARCH SERP (bắt buộc, PHẢI báo cáo - rule global `~/.claude/CLAUDE.md`)

WebSearch keyword chính -> đọc kỹ **top 10** (không dừng ở top 3-5, bỏ digicomvn.com, bỏ ads):
